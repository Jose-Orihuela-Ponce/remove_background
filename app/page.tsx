  ...
  return (
    <div className="min-h-screen px-4 py-8 text-slate-100 sm:px-6 lg:px-8">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl shadow-cyan-950/20 backdrop-blur xl:p-8">
        ...
        <section className="rounded-[2rem] border border-white/10 bg-slate-950/70 p-5 shadow-2xl shadow-black/30 backdrop-blur sm:p-4 lg:p-6">
          <BackgroundRemover />
        </section>
      </main>
      ...
      <footer className="mx-auto mt-8 max-w-6xl pb-4 text-center text-xs text-slate-400">
        <p>
          Procesamiento 100% en el navegador, sin enviar archivos a un servidor.
        </p>
      </footer>
    </div>
  );
